...
import {
  ...
  getClearanceItemsByCspsgDivision,
  updateClearanceItem,
...
export default function CspsgDivisionClearancePage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const data = await getClearanceItemsByCspsgDivision(div.id);
      setItems(data);
    } catch (err) {
        ...
        <Card padding="none">
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="No students have submitted clearance requests for your division yet."
            />
          ) : sorted.length === 0 ? (
            <EmptyState
