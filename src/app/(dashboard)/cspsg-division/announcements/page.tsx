...
import {
  ...
  getAnnouncementsByCspsgDivision,
...
export default function CspsgDivisionAnnouncementsPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (!div) {
        setError("No CSPSG division found for your account.");
        setIsLoading(false);
        return;
      }
      setDivision(div);
      const [myData, activeData] = await Promise.all([
        getAnnouncementsByCspsgDivision(div.id),
        getActiveAnnouncements(),
      ]);
