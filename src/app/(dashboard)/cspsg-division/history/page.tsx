...
import {
  ...
  getProcessedClearanceItemsByCspsgDivision,
...
export default function CspsgDivisionHistoryPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      if (!div) {
        setError("Your CSPSG division could not be found.");
        setItems([]);
        return;
      }
      setDivision(div);

      const data = await getProcessedClearanceItemsByCspsgDivision(div.id);
      setItems(data);
    } catch (err) {
