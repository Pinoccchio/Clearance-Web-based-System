...
export default function CspsgDivisionProfilePage() {
  ...
  const loadDivision = useCallback(async () => {
    ...
    const div = await getCspsgDivisionByHeadId(profile.id);
    setDivision(div);
  ...
  const handleSaveOrg = async () => {
    ...
    setIsSavingOrg(true);
    try {
      const updated = await updateCspsgDivision(division.id, {
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card padding="lg">
              ...
              {isLoadingOrg ? (
                ...
                <p className="text-sm text-gray-500">No CSPSG division linked to your account.</p>
              )}
            </Card>
          </div>
        </div>
