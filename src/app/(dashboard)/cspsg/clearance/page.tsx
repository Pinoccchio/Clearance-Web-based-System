...
export default function CspsgClearancePage() {
  ...
  async function handleAction() {
    ...
    try {
      const updated = await updateClearanceItem(
        selectedItem.id,
        {
          status: actionType,
      ...
      showToast(
        "success",
        "Action Recorded",
        `Clearance item has been ${actionLabel}.`
      );
      ...
      showToast(
        "error",
        "Update Failed",
        "Could not update the clearance item. Please try again."
      );
    } finally {
        ...
        <Card padding="none">
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="No CSP students have submitted clearance requests yet."
            />
          ) : sorted.length === 0 ? (
            <EmptyState
        ...
        {selectedItem && (
          <div className="p-6 space-y-6">
            ...
            <div className="border-t border-gray-100 pt-4 space-y-4">
              <h3 className="text-sm font-semibold text-cjc-navy">
                Take Action
              </h3>
              ...
              {actionType && (
                <div>
                  <label className="block text-xs font-medium text-gray-700 mb-1">
                    Remarks
                    {actionType === "approved" ? " (optional)" : " (recommended)"}
                  </label>
                  <textarea
