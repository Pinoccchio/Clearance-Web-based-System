...
export default function CsgDashboard() {
  ...
  const loadStats = useCallback(async () => {
    ...
    try {
      ...
      const [csgData, settingsData] = await Promise.all([
      ...
      const students: Profile[] = studentProfiles ?? [];
      ...
      // Fetch CSG-specific clearance items for these requests
      ...
      const enrichedStudents: StudentWithStatus[] = students.map((student) => {
        ...
        const csgItem = req ? itemByRequest.get(req.id) ?? null : null;
        ...
        return { ...student, latestRequest: req, csgItem, status };
      });
      ...
      console.error("Error loading CSG stats:", err);
      ...
      <div className="min-h-screen bg-surface-warm">
        <header className="bg-white border-b border-border-warm">
          <div className="px-6 py-5">
            ...
            <h1 className="text-2xl font-display font-bold text-cjc-navy">CSG Dashboard</h1>
          </div>
        </header>
    ...
    <div className="min-h-screen bg-surface-warm">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-wrap gap-2 justify-center text-sm text-warm-muted">
          ...
          <span className="px-3 py-1 bg-white border border-gray-200 rounded-full">
            {profile?.role === "csg" ? "CSG Head" : "Staff"}
          </span>
          <span className="px-3 py-1 bg-white border border-gray-200 rounded-full">
