        ...
        <Card padding="none">
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="No students have submitted clearance requests for CSG yet."
            />
          ) : filtered.length === 0 ? (
            <EmptyState
                    ...
                    <TableRow key={item.id}>
                      <TableCell>
                        <div className="flex items-center gap-3">
                          {s?.avatar_url ? (
                            ...
                            >
                              <Avatar src={s.avatar_url} name={fullName} size="sm" variant="primary" />
                            </button>
                          ) : (
                            <Avatar src={undefined} name={fullName} size="sm" variant="primary" />
                          )}
                          <div>
                      ...
                      <TableCell>
                        <span className="text-sm text-gray-600">
                          {item.request ? `${item.request.academic_year} — ${item.request.semester}` : "—"}
                        </span>
                      </TableCell>
                      <TableCell>
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              {isLoadingSubmissions ? (
                ...
                <p className="text-sm text-gray-400 text-center py-4">No requirements defined.</p>
              ) : (
