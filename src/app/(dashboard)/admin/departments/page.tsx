      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={handleAddDepartment} className="btn btn-cjc-red">
            ...
            <table className="w-full">
              <thead className="bg-surface-warm border-b border-border-warm">
                <tr>
                  ...
                  <th className="hidden sm:table-cell text-left py-3 px-4 text-sm font-medium text-cjc-navy">
                    Status
                  </th>
                      ...
                      <div className="flex items-center gap-3">
                        {dept.logo_url ? (
                          <button
                            ...
                            onClick={() => setPreviewUrl(dept.logo_url!)}
                          >
                            <img
                              src={dept.logo_url}
                              alt={`${dept.name} logo`}
