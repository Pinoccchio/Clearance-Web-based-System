...
import {
  ...
  getAnnouncementsByCspspDivision,
...
export default function CspspDivisionAnnouncementsPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (!div) {
        setError("No CSPSP division found for your account.");
        setIsLoading(false);
        return;
      }
      setDivision(div);
      const [myData, activeData] = await Promise.all([
        getAnnouncementsByCspspDivision(div.id),
        getActiveAnnouncements(),
      ]);
      ...
      console.error("Error fetching division announcements:", err);
  ...
  const roleLabel: Record<string, string> = {
    ...
    club: "Club", student: "Student", cspsp_division: "CSPSP Division",
  };
      ...
      <header className="bg-white border-b border-border-warm">
        <div className="px-6 py-5">
          <p className="text-sm text-warm-muted">
            {division ? division.name : "CSPSP Division"}
          </p>
              ...
              <div className="card p-12 text-center">
                ...
                {announcements.length === 0 ? (
                  <>
                    ...
                    <p className="text-warm-muted mb-4">Post your first announcement to students in your division.</p>
                    <button onClick={handleAddAnnouncement} className="btn btn-gold">
                      <Plus className="w-4 h-4" />
                      Post Announcement
                    </button>
