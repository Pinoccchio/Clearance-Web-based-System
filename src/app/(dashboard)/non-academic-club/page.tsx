...
export default function NonAcademicClubDashboard() {
  const user = mockUsers["non-academic-club"];
    ...
    <div className="min-h-screen bg-surface-warm">
      ...
      <div className="p-6">
        ...
        <div className="card p-8 text-center">
          ...
          <h2 className="text-xl font-display font-bold text-cjc-navy mb-2">Non-Academic Club Dashboard</h2>
