...
export default function CsgLguProfilePage() {
  ...
  useRealtimeRefresh('csg_lgus', loadLgu);
  ...
  const handleSaveOrg = async () => {
    ...
    setIsSavingOrg(true);
    try {
      const updated = await updateCsgLgu(lgu.id, {
        description: orgForm.description || null,
      });
      setLgu(updated);
      setIsEditingOrg(false);
      showToast("success", "LGU Updated", "CSG LGU information has been saved.");
    } catch {
  ...
  const handleLogoUpload = async (file: File) => {
    ...
    try {
      ...
      const url = await uploadLogo(file, "csg_lgus", lgu.id);
      const updated = await updateCsgLgu(lgu.id, { logo_url: url });
      setLgu(updated);
      showToast("success", "Logo Updated", "CSG LGU logo has been changed.");
    } catch {
          ...
          <div className="lg:col-span-1">
            <Card padding="lg" className="text-center">
              ...
              <div className="mt-6 pt-6 border-t border-gray-100 text-left">
                ...
                <Badge variant="info">CSG LGU Head</Badge>
              </div>
            </Card>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card padding="lg">
              ...
              {isLoadingOrg ? (
                ...
                <p className="text-sm text-gray-500">No CSG LGU linked to your account.</p>
              )}
            </Card>
          </div>
        </div>
