...
export default function CsgDepartmentLguClearancePage() {
  ...
  if (authLoading || isLoading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <Header title="LGU Clearance" subtitle="Your LGU clearance status" />
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header
        title="LGU Clearance"
        subtitle={lgu ? `${lgu.name} (${lgu.code})` : "Your LGU clearance status"}
      />
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <ClearanceStatusView
          ...
          loading={false}
          submitHref="/student/csg-department-lgu/submit"
        />
      </div>
    </div>
  );
