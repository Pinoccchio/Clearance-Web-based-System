...
export default function OfficeDashboard() {
  ...
  const loadStats = useCallback(async () => {
    ...
    try {
      ...
      // Parallel fetch office and settings
      ...
      console.error("Error loading office stats:", err);
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-surface-warm">
        <header className="bg-white border-b border-border-warm">
          <div className="px-6 py-5">
            <p className="text-sm text-warm-muted">{office?.name ?? "Office"}</p>
            <h1 className="text-2xl font-display font-bold text-cjc-navy">
              Office Dashboard
            </h1>
          </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="card p-4 text-center">
            ...
            <p className="text-2xl font-bold text-cjc-navy">{stats.onHold}</p>
        ...
        <div className="flex flex-wrap gap-2 justify-center text-sm text-warm-muted">
          ...
          <span className="px-3 py-1 bg-white border border-gray-200 rounded-full">
            {profile?.role === "office" ? "Office Head" : "Staff"}
          </span>
          <span className="px-3 py-1 bg-white border border-gray-200 rounded-full">
