...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        primary: "bg-cjc-red text-white hover:bg-cjc-red-light focus:ring-cjc-red",
        cjcPrimary: "bg-cjc-red text-white hover:bg-cjc-red-light focus:ring-cjc-red font-semibold",
        ...
        gold: "bg-cjc-red text-white font-semibold hover:bg-cjc-red-light focus:ring-cjc-red",
